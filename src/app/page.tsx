...
export default function AuthPage() {
    ...
    useEffect(() => {
        if (!isPending && session) router.replace("/editor");
      ...
      `}</style>
            ...
            <div
                style={{
                    ...
                    borderRadius: "50%",
                    background:
                        "radial-gradient(circle, rgba(249,98,159,0.14) 0%, transparent 65%)",
                    pointerEvents: "none",
            ...
            <div
                style={{
                    ...
                    borderRadius: "50%",
                    background:
                        "radial-gradient(circle, rgba(120,40,180,0.10) 0%, transparent 65%)",
                    pointerEvents: "none",
            ...
            <div
                style={{
                    ...
                    borderRadius: "50%",
                    background:
                        "radial-gradient(circle, rgba(249,98,159,0.06) 0%, transparent 65%)",
                    pointerEvents: "none",
                }}
            />
            {/* Dot grid */}
            ...
            >
                ...
                >
                    ...
                    <div style={{ flex: "1 1 320px", minWidth: 0 }}>
                        ...
                        >
                            A browser-based code editor. Run 10 languages instantly — no setup, no
                            install.
                        </p>
                    ...
                    >
                        ...
                        <div
                            style={{
                                ...
                                borderRadius: "50%",
                                background:
                                    "radial-gradient(circle, rgba(249,98,159,0.12) 0%, transparent 70%)",
                                pointerEvents: "none",
                            }}
                        />
                        ...
                        >
                            {mode === "signin"
                                ? "Sign in to continue to Codefyre"
                            ...
                            {(["signin", "signup"] as const).map((m) => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        transition: "all 0.2s",
                                        boxShadow:
                                            mode === m ? "0 2px 10px rgba(249,98,159,0.4)" : "none",
                                    }}
                                >
                        ...
                        >
                                    ...
                                    <input
                                        ...
                                        onFocus={(e) => {
                                            ...
                                            e.target.style.boxShadow =
                                                "0 0 0 3px rgba(249,98,159,0.09)";
                                        }}
                                        onBlur={(e) => {
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    boxShadow: loading
                                        ? "none"
                                        : "0 4px 18px rgba(249,98,159,0.45)",
                                    transition: "all 0.2s",
                                }}
