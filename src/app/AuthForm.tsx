      ...
      `}</style>
            ...
            <div
                style={{
                    ...
                    height: 600,
                    borderRadius: "50%",
                    background: "radial-gradient(circle, rgba(249,98,159,0.14) 0%, transparent 65%)",
                    pointerEvents: "none",
            ...
            <div
                style={{
                    ...
                    height: 500,
                    borderRadius: "50%",
                    background: "radial-gradient(circle, rgba(120,40,180,0.10) 0%, transparent 65%)",
                    pointerEvents: "none",
            ...
            <div
                style={{
                    ...
                    height: 300,
                    borderRadius: "50%",
                    background: "radial-gradient(circle, rgba(249,98,159,0.06) 0%, transparent 65%)",
                    pointerEvents: "none",
                }}
            />
            {/* Dot grid */}
            ...
            >
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <div
                        style={{
                            ...
                            borderRadius: 9,
                            overflow: "hidden",
                            boxShadow: "0 0 14px rgba(249,98,159,0.5)",
                            flexShrink: 0,
                        }}
                    >
                        <Image
                ...
                <nav style={{ display: "flex", alignItems: "center", gap: 6 }}>
                    ...
                    <button
                        onClick={() =>
                            toast("Sign in or create an account to use the editor", {
                                icon: "🔒",
                                style: {
                                    background: "#18181b",
                                    color: "#f4f4f5",
                                    border: "1px solid rgba(249,98,159,0.35)",
                                    borderRadius: "10px",
                                    fontSize: "13px",
                                    fontFamily: "Inter, sans-serif",
                                },
            ...
            >
                ...
                >
                    ...
                    <div style={{ flex: "1 1 320px", minWidth: 0 }}>
                        ...
                        >
                            A browser-based code editor. Run 10 languages instantly — no setup, no install.
                        </p>
                    ...
                    <div
                        style={{
                            ...
                            padding: "32px 30px",
                            boxShadow:
                                "0 32px 80px rgba(0,0,0,0.55), 0 0 0 1px rgba(249,98,159,0.07), inset 0 1px 0 rgba(255,255,255,0.05)",
                            position: "relative",
                            overflow: "hidden",
                        }}
                    >
                        ...
                        <div
                            style={{
                                ...
                                height: 200,
                                borderRadius: "50%",
                                background: "radial-gradient(circle, rgba(249,98,159,0.12) 0%, transparent 70%)",
                                pointerEvents: "none",
                            }}
                        />
                            ...
                            {(["signin", "signup"] as const).map((m) => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        fontFamily: "Inter,sans-serif",
                                        background: mode === m ? "#F9629F" : "transparent",
                                        borderWidth: 0,
                                        borderRadius: 8,
                                        color: mode === m ? "white" : "rgba(255,255,255,0.35)",
                                        cursor: "pointer",
                                        transition: "all 0.2s",
                                        boxShadow: mode === m ? "0 2px 10px rgba(249,98,159,0.4)" : "none",
                                    }}
                                >
                        ...
                        <form
                            ...
                            style={{ display: "flex", flexDirection: "column", gap: 13, position: "relative" }}
                        >
                            {mode === "signup" && (
                                <div>
                                    <label
                                    ...
                                    <input
                                        ...
                                        style={inp}
                                        onFocus={(e) => {
                                            e.target.style.borderColor = "rgba(249,98,159,0.5)";
                                            e.target.style.boxShadow = "0 0 0 3px rgba(249,98,159,0.09)";
                                        }}
                                        onBlur={(e) => {
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    gap: 8,
                                    padding: "12px",
                                    background: loading ? "rgba(249,98,159,0.4)" : "#F9629F",
                                    borderWidth: 0,
                                    borderRadius: 10,
                                    color: "white",
                                    fontSize: 14,
                                    ...
                                    fontFamily: "Inter,sans-serif",
                                    marginTop: 4,
                                    boxShadow: loading ? "none" : "0 4px 18px rgba(249,98,159,0.45)",
                                    transition: "all 0.2s",
                                }}
